...
public record MagicBlock(int m_magicNum, int m_numBlocks, int m_inlodeBlocks, int m_totalInodes, int m_inodeSize, int m_blockSize, int m_inodesPerBlock, int m_dataBlock) {
