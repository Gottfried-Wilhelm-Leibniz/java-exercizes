...
public class Context {
    ...
    public Context(Printer printer, Input input, GetFleetList getFleetList, GetModels getModels, CreateNew createNew,
                   GetAvailableRobots getAvailableRobots, GetRobotDetails getRobotDetails, CommandRobot commandRobot) {
